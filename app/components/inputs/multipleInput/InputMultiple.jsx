...
export const GenreWrapper = ({children})=>{
    ...
    return(
        <Box display={"flex"}>
            <Icon as={FaTimes} bg={"rose.600"} padding={"2px"} borderRadius={"50%"} boxSize={4} 
                    color={"white"} position={"relative"} top={"5px"} left={"10px"} 
                    onClick={()=>console.log("removing")} />
            <Box bg={"rose.500"} color={'white'} marginRight={"4px"} py={"2px"} px={"8px"} borderRadius={"5px"} fontSize={"14px"} my={"10px"} >
                {children}
            </Box>
        </Box>
    )
